...
class GlamourPinkThemeTests(unittest.TestCase):
    def test_primary_palette_is_pink(self):
        ...
        self.assertIn('500: "var(--theme-primary-500)"', theme)
        css = (ROOT / "app/dashboard/src/index.scss").read_text()
        self.assertIn("--theme-primary-500:#f653ad", css)
        self.assertIn('500: "var(--theme-accent-500)"', theme)
        self.assertIn('Manrope', theme)
        self.assertIn("--theme-primary-500:#00e08c", css)
    ...
    def test_navigation_uses_soft_pink_active_state(self):
        ...
        self.assertIn("var(--theme-active-gradient)", sidebar)
        self.assertIn("rgba(246,83,173,.20)", (ROOT / "app/dashboard/src/index.scss").read_text())
    ...
    def test_technical_surfaces_are_preserved(self):
        ...
        self.assertIn('"glamour-pink":', editor)
